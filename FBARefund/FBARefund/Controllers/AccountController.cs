...
namespace FBARefund.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (UserManager.IsInRole(user.Id, "Admin") || UserManager.IsInRole(user.Id, "CaseManager")) 
            {
                ...
                switch (res)
                {
                    case SignInStatus.Success:
                        return RedirectToAction("Home", "UserAdmin"); ;
            ...
            if(user.DeveloperToken.IsNullOrWhiteSpace() || user.DeveloperToken.IsNullOrWhiteSpace())
            {
                return RedirectToAction("AmazonInformation", "Account");
            }
        ...
        [Authorize]
        [HttpGet]
        public ActionResult AmazonInformation()
        {
            return View();
        }
